namespace Film.Kom
{
    partial class frmPaymentFurkan
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPaymentFurkan));
            PnlForm2 = new Panel();
            label5 = new Label();
            button1 = new Button();
            ...
            // PnlForm2
            // 
            PnlForm2.BackColor = Color.White;
            PnlForm2.Controls.Add(label5);
            PnlForm2.Controls.Add(button1);
            PnlForm2.Controls.Add(BtnIndienen);
            PnlForm2.Controls.Add(PicPaypal);
            PnlForm2.Controls.Add(PicMasterKaart);
            PnlForm2.Controls.Add(PicVisa);
            PnlForm2.Controls.Add(TxtPas);
            PnlForm2.Controls.Add(TxtVervaldatumYY);
            PnlForm2.Controls.Add(TxtVervaldatumMM);
            PnlForm2.Controls.Add(Txtkaarthouder);
            PnlForm2.Controls.Add(TxtCreditcard);
            PnlForm2.Controls.Add(panel3);
            PnlForm2.Controls.Add(panel2);
            ...
            BtnIndienen.MouseDown += BtnIndienen_MouseDown;
            BtnIndienen.MouseEnter += BtnIndienen_MouseEnter;
            BtnIndienen.MouseLeave += BtnIndienen_MouseLeave;
            // 
            // PicPaypal
            // 
            ...
            PicMasterKaart.Click += Pic_Click;
            // 
            // PicVisa
            // 
            ...
            TxtPas.Name = "TxtPas";
            TxtPas.Size = new Size(76, 39);
            TxtPas.TabIndex = 6;
            TxtPas.Text = "Pas nr.";
            TxtPas.TextAlign = HorizontalAlignment.Center;
            TxtPas.TextChanged += TxtCVV_TextChanged;
            // 
            // TxtVervaldatumYY
            // 
            ...
            TxtVervaldatumYY.Size = new Size(280, 39);
            TxtVervaldatumYY.TabIndex = 5;
            TxtVervaldatumYY.Text = "VERVALDATUM JJ";
            TxtVervaldatumYY.TextChanged += TxtVervaldatumYY_TextChanged;
            // 
            // TxtVervaldatumMM
            // 
            ...
            TxtVervaldatumMM.Size = new Size(228, 39);
            TxtVervaldatumMM.TabIndex = 4;
            TxtVervaldatumMM.Text = "VERVALDATUM MM";
            TxtVervaldatumMM.TextChanged += TxtVervaldatumMM_TextChanged;
            // 
            // Txtkaarthouder
            // 
            ...
            Txtkaarthouder.Size = new Size(387, 39);
            Txtkaarthouder.TabIndex = 3;
            Txtkaarthouder.Text = "KAARTHOUDER";
            Txtkaarthouder.TextChanged += Txtkaarthouder_TextChanged;
            // 
            // TxtCreditcard
            // 
            ...
            TxtCreditcard.Size = new Size(627, 39);
            ...
            PicMastercard.Click += PicMastercard_Click;
            // 
            // LblCreditcard
            // 
