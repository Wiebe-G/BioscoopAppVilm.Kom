...
namespace Film.Kom
{
    public partial class frmPaymentFurkan : Form
    {
        public frmPaymentFurkan()
        {
            InitializeComponent();
        }
        ...
        private void TxtCreditcard_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                switch (TxtCreditcard.Text.Length)
                {
        ...
        private void TxtCVV_TextChanged(object sender, EventArgs e)
        {
            ...
            if (tb == null) return;
            LblPas.Text = (string.IsNullOrEmpty(tb.Text) || tb.Text == "Pas") ? "0000" : tb.Text;
        }
